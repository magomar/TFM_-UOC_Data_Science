...
\subsubsubsection{VGG: network architecture based on repeating blocks}
...
\subsubsubsection{GoogleLeNet (aka Inception): networks with parallel concatenations}
...
\begin{figure}[hpt]
	\centering
	\includesvg[scale=0.8]{images/ch3/functionclasses.svg}
